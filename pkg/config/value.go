...
// func GetRenderedConfFromDefaultConf(port int) (out []byte, err error) {
//
...
//		return
//	}
func GetRenderedConfFromDefaultConf(remote_Port int) (out []byte, err error) {
	b := bytes.NewBuffer(nil)
